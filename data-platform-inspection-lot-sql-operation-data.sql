...
(
    ...
    CONSTRAINT `DPFMInspectionLotOperationDataPlannedOperationValueUnit_fk` FOREIGN KEY (`PlannedOperationValueUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`)
